...
##  [/TodoApp.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/TodoApp.Client)
...
## [/TodoApp](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/TodoApp)

The .NET 6 `/TodoApp` backend server is required for this App's dynamic functions including the Hello API on the home page
